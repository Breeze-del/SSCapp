...
public class RefreshView extends LinearLayout{
    ...
    private void init() {
        ...
        anim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) refreshView.getLayoutParams();
    ...
    private void initRefreshView() {
        //刷新视图顶端的的view
        refreshView = LayoutInflater.from(mContext).inflate( R.layout.fragment_refresh_header, null);
        ll_ok = (LinearLayout) refreshView.findViewById(R.id.ll_ok);
        ll_refresh = (LinearLayout) refreshView.findViewById(R.id.ll_refresh);
        bezierView = (YPXBezierView) refreshView.findViewById(R.id.bw);
        ...
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT, -refreshTargetTop);
    ...
    public void refreshOK() {
        ...
        tv_ok.setText("刷新成功");
        iv_ok.setImageDrawable(getResources().getDrawable(R.mipmap.listview_pull_ok));
    }
    ...
    public void refreshFailed() {
        ...
        ll_ok.setVisibility(View.VISIBLE);
        tv_ok.setText("刷新失败");
        iv_ok.setImageDrawable(getResources().getDrawable(R.mipmap.listview_pull_failure));
    }
